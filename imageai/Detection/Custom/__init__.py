...
class DetectionModelTrainer:
    ...
    def evaluateModel(self, model_path, json_path, batch_size=4, iou_threshold=0.5, object_threshold=0.4, nms_threshold=0.45):
        """
...
class CustomObjectDetection:
    ...
    def detectObjectsFromImage(self, input_image="", output_image_path="", input_type="file", output_type="file",
                               extract_detected_objects=False, minimum_percentage_probability=35, nms_treshold=0.1,
                               display_percentage_probability=True, display_object_name=False, thread_safe=False):
